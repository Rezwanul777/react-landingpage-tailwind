      ...
      <>
         <nav className='w-full h-[80px] bg-white border-b'>
            <div className='md:max-w-[1480px] max-w-[600px] m-auto w-full h-full flex justify-between items-center'>
               ...
               <img src={logoImg} height={60} width={80} alt="logo"/>
            ...
            <div className='hidden md:flex'>
               <button className='flex justify-between items-center  bg-transparent  px-6 gap-2'>Login
                  <img src={lockImg}  alt="lock" />
               </button>
               <button className='bg-[#20B486] px-7 py-3 rounded-md text-white  font-bold'>Sign up for Free</button>
            </div>
            <div className='md:hidden' onClick={handleClick}>
               <img src={toggle?close:hamburgerMenu} alt="hambarg" />
            </div>
